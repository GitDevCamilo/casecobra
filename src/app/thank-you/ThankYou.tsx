    ...
    return (
      <div className="w-full mt-24 flex justify-center">
        <div className="flex flex-col items-center gap-2">
          ...
          <h3 className="font-semibold text-xl">Cargando tu pedido...</h3>
      ...
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="max-w-xl">
          ...
          <h1 className="mt-2 text-4xl font-bold tracking-tight sm:text-5xl">
            Tu funda está en camino!
          </h1>
          <p className="mt-2 text-base text-zinc-500">
            Hemos recibido su pedido y lo estamos preparando.
          </p>
        ...
        <div className="mt-10 border-t border-zinc-200">
          <div className="mt-10 flex flex-auto flex-col">
            ...
            <p className="mt-2 text-sm text-zinc-600">
              En CaseCobra creemos que la funda de un teléfono no solo debe
              verse bien, sino que también debe durar muchos años. Por eso,
              nuestras fundas están hechas con los mejores materiales y con un
              diseño único. ¡Esperamos que disfrutes tu nueva funda!
            </p>
          </div>
        </div>
