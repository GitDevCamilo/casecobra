...
const DesignPreview = ({ configuration }: { configuration: Configuration }) => {
  ...
  const { mutate: createPaymentSession } = useMutation({
    ...
    onSuccess: ({ url }) => {
      ...
      else throw new Error("No se ha podido crear la sesión de pago"); //no se puede recuperar la url de pago
    },
    onError: () => {
      toast({
        title: "Algo salió mal",
        description:
          "Por favor, inténtalo de nuevo o contacta con nosotros para obtener ayuda",
        variant: "destructive",
      });
    },
  });
  ...
  return (
    <>
      ...
      >
        <Confetti
          active={showConfetti}
          config={{ elementCount: 200, spread: 260 }}
        />
      </div>
      ...
      <div className="mt-20 flex flex-col items-center md:grid text-sm sm:grid-cols-12 sm:grid-rows-1 sm:gap-x-6 md:gap-x-8 lg:gap-x-12">
        ...
        <div className="sm:col-span-12 md:col-span-9 text-base">
          <div className="grid grid-cols-1 gap-y-8 border-b border-gray-200 py-8 sm:grid-cols-2 sm:gap-x-6 sm:py-6 md:py-10">
            <div>
              <p className="font-medium text-zinc-950">A destacar</p>
              <ol className="mt-3 text-zinc-700 list-disc list-inside">
                <li>Compatible con carga inalámbrica</li>
                <li>Protección contra caídas</li>
                <li>Material reciclable</li>
                <li>5 años de garantía de impresión</li>
              </ol>
            </div>
            <div>
              <p className="font-medium textzinc-950">Materiales</p>
              <ol className="mt-3 text-zinc-700 list-disc list-inside">
                <li>Alta calidad, material resistente y duradero</li>
                <li>Revestimiento resistente a arañazos y huellas</li>
              </ol>
            </div>
          </div>
          ...
          <div className="mt-8">
            ...
            <div className="mt-8 flex justify-end pb-12">
              ...
              >
                Comprar <ArrowRight className="h-4 w-4 ml-1.5 inline" />
              </Button>
            </div>
          </div>
        </div>
